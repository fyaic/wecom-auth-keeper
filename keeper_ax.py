...
from ApplicationServices import (
    ...
    AXUIElementPerformAction, AXValueGetValue, kAXValueCGPointType, kAXValueCGSizeType,
)
from Quartz import (
...
def click(element, window):
    ...
    if ax_get(element, "AXRole") in {"AXButton", "AXLink"} and ax_perform(element, "AXPress") == 0:
        return
